...
date: 2024-04-12T12:40:42.375Z
updated: 2024-04-13T12:40:42.375Z
tags: 
  - unlock
  - remove screen lock
categories:
...
The steps below work if your Apple iPhone 6 Plus or iPad runs iOS 15.2 or later and is connected to the internet. Here's what you need to do when you **forgot iPhone PIN**:
...
- To begin with, put your Apple iPhone 6 Plus into DFU recovery mode.
- Then, connect it to a PC or Macintosh through a Lightning link.
- Select your Apple iPhone 6 Plus in the Finder sidebar on Mac or iTunes on the PC.
- Pick Restore when you see the choice to Restore. Let the download finish if the download takes over 15 minutes and your device leaves the recovery mode screen. Then, at that point, turn off your Apple iPhone 6 Plus and start once more.

![click restore](https://images.wondershare.com/drfone/article/2022/11/forgotten-iphone-pin-2.jpg)

- Disconnect your Apple iPhone 6 Plus, then, at that point, turn it on and set it up. That's all you need to do.

### 2\. Use Find My iPhone in iCloud

Apple allows clients to erase iPhone data to safeguard it from others remotely. However, your lock screen can still protect your data if you don't erase the iPhone. No one can unlock the screen unless they enter the correct password. After too many wrong password attempts, your Apple iPhone 6 Plus will be locked. So no one can then touch your user data.
...
**Step 3.** Click "All Devices" and pick the Apple iPhone 6 Plus device you need to unlock.

**Step 4.** Click the "Erase iPhone" button. Subsequently, set up the Apple iPhone 6 Plus device and set another lock screen PIN. With iCloud, you can unlock your iDevice without even touching your device.

![icloud unlock](https://images.wondershare.com/drfone/article/2022/11/forgotten-iphone-pin-3.jpg)

### 3\. Unlock it with iTunes

Suppose you use iTunes to restore the Apple iPhone 6 Plus in recovery mode; it will install the latest iOS to your device. Doing so will erase all user data from the Apple iPhone 6 Plus device, including the lock screen. So, this is also an excellent way to unlock your Apple iPhone 6 Plus. However, you must keep a backup of your important files before doing so.
...
**On iPhone 8/8 Or more and Above:** Hold the power/side button and press any of the volume buttons until a slider appears. Move the slider to turn off the Apple iPhone 6 Plus device. Next, press and hold the power button and connect your Apple iPhone 6 Plus to the PC. Hold the button until the Apple iPhone 6 Plus device shows the recovery mode screen.

**On iPhone 7/7 Or Below:** Press and hold the power button until you see the power off slider. Next, move the slider to turn off the iPhone. Then, press the Volume (-) button and connect the Apple iPhone 6 Plus device to the PC. Continue to hold the button until you see the recovery mode screen.

**Step 2. Restore your Apple iPhone 6 Plus.**

After you connect your Apple iPhone 6 Plus to the PC, you will see a popup window in iTunes. It will warn about an issue with the "Your iPhone name" and ask you to restore it. In that window, select "Restore" to erase the iPhone. If iTunes doesn't run naturally, open iTunes by double tapping it.

**Step 3. Set up iPhone.**

Keep waiting until the restoration completes. Then, a short time later, go to your Apple iPhone 6 Plus and follow the on-screen directions. That will allow you to set up and utilize your device.
...
**Step 3. Confirm Your Apple iPhone 6 Plus Model**
...
Simply in almost no time, your Apple iPhone 6 Plus will be unlocked effectively. However, kindly note this unlocking system will likewise wipe all the files and settings on your device. Therefore, you must have a backup of your essential documents beforehand.
...
## How Do You Remove Restricted Mode on Apple iPhone 6 Plus

Restricted Mode on iPhone is useful for controlling access to certain content. If you need to remove these restrictions, learn **how to disable Restricted Mode on your Apple iPhone 6 Plus** by reading the article. The feature provides a layer of security and content filtering. However, it can limit functionality in some apps.

Follow the steps outlined in the page's latter part to learn **how to turn off Restricted Mode on your Apple iPhone 6 Plus**. This will grant you unrestricted access to all apps and content, ensuring a smoother and more flexible user experience. To know more, let's get started.
...
- **Functionality restrictions**. Restricted Mode can also turn off specific functionalities like in-app purchases and the Apple iPhone 6 Plus device camera. It ensures a more controlled and secure user experience.
- **4-digit passcode.**The inclusion of a 4-digit passcode adds an extra layer of security. It prevents unauthorized changes to the Apple iPhone 6 Plus settings or Apple ID.
...
If you want to know **how to remove Restricted Mode on your Apple iPhone 6 Plus,** it's not as simple as you may have desired. Here are several reasons:
...
In cases of secondhand or refurbished iPhones, the Apple iPhone 6 Plus device may have restrictions that limit the removal of Restricted Mode. These restrictions are set to maintain the Apple iPhone 6 Plus device's integrity and compliance with certain standards.
...
Enabling Restricted Mode on your Apple iPhone 6 Plus is prudent, especially for parents. It ensures a secure and controlled digital environment for their children. Follow these simple steps to turn on Restricted Mode:

- **Step 1**: Go to **Settings** > **Screen Time** > **Content & Privacy Restrictions** on your Apple iPhone 6 Plus. Next, Toggle the switch next to **Content & Privacy Restrictions** to turn it on.
...
If you want to know **how to turn off Restricted Mode on your Apple iPhone 6 Plus**, here are three efficient methods to do so. Whether on a specific iOS version or facing a forgotten passcode, these provide solutions for every scenario.
...
- **Step 1**: Open the **Settings** app on your Apple iPhone 6 Plus and scroll down to find **Screen** **Time** > **Content** **& Privacy Restrictions**. Enter your passcode when prompted.
...
- **Step 2**: Toggle off the switch next to **Content & Privacy Restrictions**. This action turns off Restricted Mode on your Apple iPhone 6 Plus.
...
- **Unlocks Without Data Loss.**You regain access to your Apple iPhone 6 Plus without compromising your valuable information.
...
- **Step 2:** Ensure your Apple iPhone 6 Plus is connected to the computer using a USB cable. Wait for Dr.Fone to detect your Apple iPhone 6 Plus automatically. Next, click the **Unlock Now** button.

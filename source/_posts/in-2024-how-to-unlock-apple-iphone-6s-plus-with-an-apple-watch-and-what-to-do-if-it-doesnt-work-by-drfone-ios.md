---
title: In 2024, How to Unlock Apple iPhone 6s Plus With an Apple Watch & What to Do if It Doesnt Work
date: 2024-07-15T00:10:09.680Z
updated: 2024-07-16T00:10:09.680Z
tags: 
  - unlock
  - remove screen lock
categories:
  - ios
  - iphone
description: This article describes How to Unlock Apple iPhone 6s Plus With an Apple Watch & What to Do if It Doesnt Work
excerpt: This article describes How to Unlock Apple iPhone 6s Plus With an Apple Watch & What to Do if It Doesnt Work
keywords: how many attempts to unlock iphone,unlock iphone 11 12 13 without passcode,forgot passcode iphone 6,unlock disabled iphone 13,reset iphone backup password,how to remove face id on iphone 13,how to unlock iphone to use usb accessories,how to unlock iphone without passcode or face id,how to unlock iphone with broken screen,unlock iphone face id wearing mask,unlock iphone 14
...
Have you forgotten the passcode iPhone 6? We know forgetting your Apple iPhone 6s Plus passcode can be a frustrating experience, but luckily it is possible to unlock your device. Using different methods, we will show you how to unlock your Apple iPhone 6s Plus 6 with a forgotten passcode.
...
![find My Apple iPhone 6s Plus](https://images.wondershare.com/drfone/article/2022/11/forgot-passcode-iphone-6-1.jpg)
...
- **Step 2:** Select "All Devices" at the top of the screen and find out your Apple iPhone 6s Plus from the list of devices.
- **Step 3:** Click "Erase iPhone" and confirm that you want to erase your device.

Once your Apple iPhone 6s Plus has been erased, it can be set up as a new device and you can choose a new passcode.

### 2\. Unlock it via Recovery mode with iTunes

You can use Recovery mode to reset your device if you've synced your Apple iPhone 6s Plus with iTunes. This method will erase all of the data on your Apple iPhone 6s Plus, so confirm you have a backup before proceeding.
...
- **Step 1:** To begin with, you need to connect your Apple iPhone 6s Plus to a computer and turn on iTunes.
- **Step 2:** While your Apple iPhone 6s Plus is connected, restart it by pressing and holding the Sleep/Wake and Home buttons simultaneously. Keep holding these buttons until the recovery mode screen shows up.
...
**Step 2:** To connect your Apple iPhone 6s Plus to the computer, you require a USB cable.
...
**Step 4:** Once your device enters into DFU mode or Recovery mode, Dr.Fone will ask you to choose the right firmware for your Apple iPhone 6s Plus 6.
...
You need to wait as the process may take several minutes. So be patient and don't interrupt the process; otherwise, it may permanently damage your Apple iPhone 6s Plus. Once the process is completed, your Apple iPhone 6s Plus will be unlocked, and you can choose a new passcode.

![unlock iphone successfully](https://images.wondershare.com/drfone/guide/unlock-ios-screen-9.png)


This is a very easy-to-use way to reset your Apple iPhone 6s Plus passcode. So, if you're looking for a hassle-free solution, this is the one you should obtain.

As we told you earlier, any method you follow will lose your data, as there is no way to unlock your Apple iPhone 6s Plus 6 without losing the data. So, how can you back up your Apple iPhone 6s Plus to avoid forgetting the passcode? Let's find out.

## How Can I Back Up My Apple iPhone 6s Plus to Avoid Forgetting Passcode Again?

[Wondershare Dr.Fone](https://drfone.wondershare.com/iphone-backup-and-restore.html) is an excellent tool that can help you keep your Apple iPhone 6s Plus data to avoid losing it. The software is extremely easy to use and supports all iOS devices.
...
**Step #2: Connect your Apple iPhone 6s Plus 6**

Now you will need to connect your Apple iPhone 6s Plus 6 to the computer with a lightning cable and click "Back Up Now" to start backing up your device. Dr.Fone will now start scanning your Apple iPhone 6s Plus for data. Once it's finished, you can move on to the next step.

![backup or restore](https://images.wondershare.com/drfone/guide/ios-backup-and-restore-1.png)

**Step #3: Hit Backup Button**

Once it's finished, you can safely disconnect your Apple iPhone 6s Plus and keep the backup file safe. So that is how you can safely back up your Apple iPhone 6s Plus without losing any data.
...
If your Apple iPhone 6s Plus is disabled, restoring your device using above mentioned methods is the only way to fix it. However, this will erase all your data, so ensure you have a backup before proceeding.
...
You can unlock your Apple iPhone 6s Plus 6 without a passcode by following the steps mentioned in this article. However, this will erase all your data, so ensure you have a backup before proceeding.

### 4\. I tried unlocking my iPhone using iTunes, but it's not working. What should I do?

If you cannot unlock your Apple iPhone 6s Plus using iTunes, you can try Dr.Fone-Screen Unlock. This software is extremely easy to use and supports all iOS devices. Plus, it won't erase your data if you have a backup.

## Conclusion

We hope this article helped you reset your Apple iPhone 6s Plus if you forgot the passcode iPhone 6. As you can see, there are several ways to do it; however, any method you follow will result in data loss. So, ensure you have a backup before proceeding.

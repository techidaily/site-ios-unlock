---
title: How to Turn Off Find My Apple iPhone 13 Pro Max when Phone is Broken?
date: 2024-07-15T02:01:24.262Z
updated: 2024-07-16T02:01:24.262Z
tags: 
  - unlock
  - remove screen lock
categories:
  - ios
  - iphone
description: This article describes How to Turn Off Find My Apple iPhone 13 Pro Max when Phone is Broken?
excerpt: This article describes How to Turn Off Find My Apple iPhone 13 Pro Max when Phone is Broken?
keywords: forgot iphone pin,change apple id on ipad,iphone passcode changed itself,factory reset locked iphone without itunes,fix iphone passcode not working,turn off restricted mode,iphone lock screen with notifications,iphone lost mode unlock,how to turn off find my iphone when phone is broken,swipe up to unlock iphone
thumbnail: https://thmb.techidaily.com/8131b30173d2b241efc12bf25f704d9229322eedc156666a853f82f3e47dee0b.jpg
---

## How to Turn Off Find My Apple iPhone 13 Pro Max when Phone is Broken?
...
The best part about this application is that it is free of cost. It usually comes built-in your Apple iPhone 13 Pro Max already, but if not, you can easily download it from the app store. Sign in with your Apple ID, and it will automatically locate your Apple iPhone 13 Pro Max no matter where you go.
...
Dr.Fone can also be a great solution for how to turn off Find My iPhone when your Apple iPhone 13 Pro Max is broken.

**Step 1: Install Dr. Fone**

Launch Wondershare Dr.Fone on your computer and connect your Apple iPhone 13 Pro Max with it via cable.
...
Jailbreak your Apple iPhone 13 Pro Max by following the instructions given by the system. Once you complete them, click on "Finish Jailbreak."
...
**Step 6: Unlock your Apple iPhone 13 Pro Max**
...
iCloud is the most secure storage drive introduced by Apple. It keeps your gallery, your reminders, contacts, and your messages up to date. Moreover, it also organizes and stores your files while keeping them private and secure. iCloud strongly integrates your Apple iPhone 13 Pro Max with other iOS devices so you can share your data, documents, and location with other iCloud users.

As mentioned earlier, turning off Find My iPhone can be very complex. But if your Apple iPhone 13 Pro Max is damaged in some way, turning it off can be much more stressful. Here, iCloud can come to the rescue as it’s the most effective solution for how to turn off Find My iPhone when your phone is broken.
...
**Step 2:** Click on the "Find My iPhone" icon at the end of the page. The app will start locating your device, but as your Apple iPhone 13 Pro Max is damaged, it might not find anything.

![select the option of find my iphone](https://images.wondershare.com/drfone/article/2021/06/turn-off-find-my-iphone-1.jpg)

**Step 3:** Click on the "All Devices" option from the top. Select your Apple iPhone 13 Pro Max, which you want to remove by clicking on "Remove from account."
...
**Step 1:** Connect your Apple iPhone 13 Pro Max to your computer via cable and wait for your computer to detect your device.

**Step 2:** As soon as your Apple iPhone 13 Pro Max is detected, open iTunes and force restart your phone to activate the Recovery Mode. Activating this mode is different for different models of iPhone.
...
- For iPhone 6s, and Previous Models: Press and hold the Home Button and Power button concurrently until your Apple iPhone 13 Pro Max shows the Apple logo.

Once your Apple iPhone 13 Pro Max shows the Apple logo, it means the Recovery Mode is activated.
...
## The Best Methods to Unlock the 'iPhone Locked to Owner' for Apple iPhone 13 Pro Max
...
The Activation Lock works by associating a device with the iCloud account of the owner. When the Apple iPhone 13 Pro Max device is set up or restored, it prompts the user to sign in with their Apple ID and activates Activation Lock.

### Activation Lock Status

Once enabled, Activation Lock securely stores the Apple iPhone 13 Pro Max device's unique identifier (IMEI or serial number). It also stores the associated iCloud account details on Apple's servers. This information is used to verify the Apple iPhone 13 Pro Max device's status during activation and prevent unauthorized use.

### Locking Mechanism

If a device with Activation Lock is lost or stolen, the owner can activate Lost Mode using the Find My app or iCloud website. Lost Mode remotely locks the Apple iPhone 13 Pro Max device, preventing anyone from accessing the user's data. It also prevents device use without the owner's Apple ID and password.

### Device Recovery

In Lost Mode, the owner can provide contact information and display a custom message on the Apple iPhone 13 Pro Max device's screen. These can help in facilitating its return. The device remains locked until the owner either unlocks it through iCloud or erases its data remotely.

### iCloud Activation Lock Bypass

With Activation Lock, you get an added layer of security. This makes it challenging for unauthorized individuals to use a locked device. Apple's servers confirm the Apple iPhone 13 Pro Max device's activation status before allowing access to the OS. Thus, bypassing Activation Lock requires the original owner's Apple ID and password.

### Activation Lock on Used Devices

When purchasing a used Apple device, you should ensure that Activation Lock is disabled. Otherwise, the Apple iPhone 13 Pro Max device will remain locked to the previous owner's iCloud account. Apple provides guidelines and procedures for sellers to remove Activation Lock.

## Part 2: 5 Best Methods To Remove the Apple iPhone 13 Pro Max Locked to Owner Security

Having an iPhone locked to its previous owner's security can be frustrating. That's why finding effective methods to remove the lock is crucial. Luckily, various methods exist to ****bypass the Apple iPhone 13 Pro Max locked to the owner for free****. Given below are the top 5 methods to resolve this issue:

### Method 1: Use the Old iOS Passcode To Unlock the Apple iPhone 13 Pro Max device

If you've recently obtained a used iPhone, there is a possibility that the old iOS passcode might still be effective. When an iPhone is locked to its owner, you will find an option to unlock the Apple iPhone 13 Pro Max device using the passcode. It presents another viable option to remove the lock.

To proceed, you will need to contact the previous owner of the Apple iPhone 13 Pro Max device and request the passcode. Use the following guide after getting the old passcode of your Apple iPhone 13 Pro Max:
...
### Method 2: Ask the Owner To Erase the Apple iPhone 13 Pro Max device Using iCloud
...
To make this procedure work, the owner will need to use the Find My Device feature from the iCloud website. Here is what the owner needs to do to resolve Activation Lock from your Apple iPhone 13 Pro Max:
...
- ****Step 2:**** On the following screen, select your Apple iPhone 13 Pro Max from "All Devices." Now choose "Erase iPhone" from the available options to erase the Apple iPhone 13 Pro Max device and remove the Activation Lock.

![tap on erase iphone](https://images.wondershare.com/drfone/article/2023/06/iphone-locked-to-owner-4.jpg)

### Method 3: Use the DNS Method To Unlock the Apple iPhone 13 Pro Max Locked to Owner

When you are unable to access the Apple iPhone 13 Pro Max device, the DNS method can be an alternative solution. This method involves changing the DNS settings on your Apple iPhone 13 Pro Max to bypass the activation lock screen. However, the procedure works only for devices running on older iOS versions.

The reason is that the process uses a loophole to allow you access to the Apple iPhone 13 Pro Max device. This loophole has now been patched by Apple. Given below is the detailed process to unlock your Apple iPhone 13 Pro Max Activation Lock:

- ****Step 1:**** Power on your iDevice or restart it if your Apple iPhone 13 Pro Max is already powered on. Access your Apple iPhone 13 Pro Max Settings to tap "Wi-Fi" and navigate to the "Choose Wi-Fi Network" option.
...
- ****Step 4:**** Save the changes by selecting "Save." Use the back arrow button to go back and choose "Ask to Join Networks." Enter the network password and tap "Join." Press the back arrow button when your Apple iPhone 13 Pro Max attempts to activate. Afterward, continue to set up your Apple iPhone 13 Pro Max.

### Method 4: Take Help From the Online iCloud Activation Lock Removal Service

What to do if you have been unable to contact the previous owner and the DNS method isn't working? The answer is you can also employ an online iCloud Activation removal service. These services charge you some money and unlock your Apple iPhone 13 Pro Max. All you need to provide them is your Apple iPhone 13 Pro Max IMEI number. The process is done remotely and takes 24 to 48 hours to complete.
...
- ****Step 1:**** Use your computer's browser to visit the official DriectUnlocks website. Enter your Apple iPhone 13 Pro Max's IMEI number and select the Apple iPhone 13 Pro Max model in the provided box.
...
- With this tool, you can also remove your Apple ID from your Apple iPhone 13 Pro Max if you have forgotten the password.
...
Removing the iCloud Activation Lock with Wondershare Dr.Fone is simple and fast. You don't need any technical skills to unlock your Apple iPhone 13 Pro Max. Follow these steps to remove iCloud Activation Lock with Dr.Fone:

- ****Step 1: Choose iCloud Activation Lock Removal****

After launching the Dr.Fone on your computer, move to "Screen Unlock" in the "Toolbox" tab. Here, choose "iOS" and click "iCloud Activation Lock Removal." Now connect your locked Apple iPhone 13 Pro Max to the computer using a reliable USB cable.
...
Afterward, tap "Start" to begin the iCloud Activation Lock bypassing process. You will first have to confirm whether your device is GSM or CDMA. If the Apple iPhone 13 Pro Max device is GSM, the unlocking process won't harm it. However, you will lose calling or other cellular functions if it is CDMA.

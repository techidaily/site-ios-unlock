---
title: In 2024, How to Remove and Reset Face ID on Apple iPhone 6s
date: 2024-07-15T00:03:05.242Z
updated: 2024-07-16T00:03:05.242Z
tags: 
  - unlock
  - remove screen lock
categories:
...
keywords: erase iphone when locked,total wireless unlock,iphone passcode changed itself,fix iphone unavailability,how to unlock iphone with broken screen,iphone auto lock greyed out
...
If the new Apple iPhone 6s is your first-ever iPhone, or if you have neither upgraded your Apple iPhone 6s from the 6/7/8 series nor have kept abreast with the happenings in the Apple world, you might wonder what this newfangled thing called Face ID is.

Face ID is an authentication system that came with iPhone X for the first time, and then the Apple iPhone 6s 13, the Apple iPhone 6s 14, and now the Apple iPhone 6s 15. Like Touch ID that uses your fingerprints, Face ID uses your face metrics to authenticate you for everything, the way Touch ID does.
...
Most of us know that we can unlock iPhone with our face via Face ID instead of a thumbprint or passcode. But actually, Face ID does more than just that. Let us learn more cool things you can do with Face ID, which helps you to make a decision if you still want to disable it. Here‘s what you can do on your Apple iPhone 6s 13/12/11 with Face ID:

### II.I Unlock Your Apple iPhone 6s

As an authentication mechanism, Face ID enables you to [unlock your Apple iPhone 6s 13](https://drfone.wondershare.com/unlock/how-to-unlock-an-iphone-13.html)/iPhone 12/iPhone 11 with a look. How to do that? Here are the steps:

Step 1: Pick your Apple iPhone 6s up in your hands or tap the screen to wake it up.
...
When the lock symbol changes to the unlocked position, you can swipe up to unlock your Apple iPhone 6s using Face ID and get to the Home Screen.

Note that Face ID will not work in landscape mode on an iPhone.

### II.II Making Purchases Using Face ID on Your Apple iPhone 6s
...
#### How to use Face ID on Apple iPhone 6s to make purchases in App Store, Book Store, and iTunes Store
...
#### How to use Face ID on Apple iPhone 6s to pay with Apple Pay

Step 1: If Apple Pay is supported by banking institutions in your country, you can set it up by adding a supported bank‘s credit card, debit card, or prepaid card to the Wallet app on your Apple iPhone 6s 13/12/11.
...
Step 4: Look at your Apple iPhone 6s to authenticate yourself using your Face ID and make the purchase.

Step 5: When paying at retail outlets, hold your Apple iPhone 6s (top being close to the reader) and wait for the checkmark and Done message.

Step 6: To pay using Apple Pay on websites, choose Apple Pay as the payment method, double press the Side Button, look at your Apple iPhone 6s, and wait for the Done message and checkmark to finish the process.
...
That‘s it. Now, when you get a call and your Apple iPhone 6s 13 is ringing loud, looking at your Apple iPhone 6s 13/12/11 will cause it to lower the volume. When an alarm goes off, you can lower the volume by simply looking at your Apple iPhone 6s. Additionally, your Apple iPhone 6s screen will not dim or switch off for the duration you are looking at it. This means you can now read those books on Kindle without constantly tapping the screen for it to stay awake.

### II.IV Filling Passwords in Safari Automatically Using Face ID

Face ID also allows users to fill passwords in Safari automatically for a faster and more convenient login experience on your Apple iPhone 6s with Face ID.
...
## Part III: How to Remove Face ID on Apple iPhone 6s
...
Lately, with the COVID-19 pandemic, we have seen how Face ID struggles to work for us, and why? Because it cannot scan our faces with masks! So, it makes sense to remove Face ID from our iPhones and rely solely on passcodes. Alternatively, you want to reset your Face ID on your Apple iPhone 6s 13/12/11 and set it again if you have put on some 'COVID weight' owing to working from home.

Most of the time, the best and the simplest thing you can do to resolve your hardware and software issues is to restart the Apple iPhone 6s device in question. To restart your Apple iPhone 6s 13/12/11, long-press the Side Button until the power slider appears and drag it to shut the Apple iPhone 6s device off. Then, use the Side Button to start the phone again.

Sometimes, the issues have a way of persisting, and a restart does not resolve them. the TrueDepth system might have developed a fault and Face ID might stop working. Or you got the dreaded "problem detected with TrueDepth camera" message on your Apple iPhone 6s 13/12/11. In that case, you would like to know how to reset and remove Face ID on your Apple iPhone 6s 13 to see if that helps, before you are required to go to an Apple Store for service.

Step 1: Go to Settings > Face ID and Passcode.

Step 2: Scroll and tap the option "Reset Face ID" to remove Face ID on your Apple iPhone 6s 13/12/11.

![wa stickers](https://images.wondershare.com/drfone/article/2021/09/remove-face-id-on-iphone-13-11.jpg)

## Part IV: How to Set Up Face ID on Your Apple iPhone 6s

Sometimes, you may just want to disable Face ID temporarily or the issue gets solved, and want to activate Face ID again. Setting up a Face ID on your Apple iPhone 6s 13 is easy. To set up Face ID, sit in a comfortable spot with adequate lighting and follow these steps:
...
Step 3: Hold your Apple iPhone 6s in the portrait orientation at about an arm‘s length away from your face and then tap Get Started.
...
If you **forget the passcode on your Apple iPhone 6s**, you won't have the option to access its information and use it flawlessly. What's more disturbing is that if you keep entering the wrong ones, your Apple iPhone 6s will be locked. It would help if you opened it, be it a 4-digit passcode, 6-digit passcode, Fingerprint, or Face ID.
...
Yes, you can unlock your locked iPhone without a passcode. If you **forgot passcode on iPhone**, Apple's proper prescribed way is to reset your Apple iPhone 6s. In other words, do a factory reset to erase the passcode. However, many individuals can't do this strategy since it's irksome and may lead to a few unforeseen issues. Such issues can worsen the condition.
...
Utilizing iCloud if the Find My feature is enabled before you **forgot iPhone passcode**. By visiting iCloud.com, you can erase your Apple iPhone 6s from a distance. Moreover, you can eliminate the Apple iPhone 6s device's screen lock to unlock it.
...
How to bypass the Apple iPhone 6s passcode or eliminate the passcode? The method is to utilize iTunes. However, using iTunes to restore the Apple iPhone 6s in recovery mode will erase all data from the Apple iPhone 6s device.
...
Additionally, ensure you remember the Mac ID credentials on the iDevice, or you won't be able to use it. Finally, utilizing iTunes will eliminate the lock screen's passcode but not the firmware. Considering all these, bypassing a passcode isn't so hard. Here's how to bypass the Apple iPhone 6s passcode with iTunes:

**Step 1. Enter the recovery mode on your Apple iPhone 6s, iPad, or iPod Contact.**

- **On iPhone 8/8 Or later:** Hold the Power/Side button on your phone and one of the volume buttons. Keep holding until the power off slider shows up. Flip the slider to switch off the iPhone. Next, press and hold the power button and connect your Apple iPhone 6s to the PC. Hold the button until the Apple iPhone 6s transforms into the recovery mode screen.
- **On iPhone 7/7 Or Below:** Press and hold the power button until you see the slider. Flip the slider to switch off the iPhone. Press the Volume Down button and connect the Apple iPhone 6s to the PC. Continue to hold the button until you see the recovery mode screen.

**Step 2. Restore your Apple iPhone 6s.**

After connecting your Apple iPhone 6s to the PC, you will see a popup window in iTunes saying, "There is an issue with the 'iPhone name' that needs it to be restored." In that window, select "Restore" to erase the iPhone. (If iTunes doesn't run, open iTunes by double tapping it.)

**Step 3. Set up iPhone.**

Hang tight for the process to wrap up. Then, a short time later, go to your Apple iPhone 6s and follow the on-screen directions to set up and utilize your phone again.

![itunes unlock](https://images.wondershare.com/drfone/article/2022/11/forgot-passcode-on-iphone-2.jpg)

### 3\. "Erase iPhone" Option

However long the locked iPhone has a functioning WiFi connection, you can now delete the Apple iPhone 6s device from the lock screen. This method only works if it is running iOS 15.2 or above.

![erase iphone](https://images.wondershare.com/drfone/article/2022/11/forgot-passcode-on-iphone-3.jpg)

After several wrong attempts, an "Erase iPhone" choice will appear on the screen's lower part. Just tap on that, confirm you need to erase the Apple iPhone 6s and enter your Apple ID details afterward. The device will then reset itself, completely deleting all data and beginning as a new one.

If the Apple iPhone 6s device can't connect to WiFi or data, the Apple ID approval step will fail. Then the Apple iPhone 6s cannot be erased, and you will need to turn to the conventional DFU strategy.

### 4\. Use Siri

You can also use Siri to bypass the Apple iPhone 6s passcode. Using Siri to erase the lock is an iPhone hack existing on iOS devices running iOS 8.0 to iOS 10.1. You can utilize Siri to bypass your Apple iPhone 6s passcode by switching off cellular data. You also need to read a new message and set a reminder, and that's just the beginning.
...
**Step 1.** Press and hold the "Home" button to actuate Siri on your Apple iPhone 6s.
...
Before sidestepping the Apple iPhone 6s lock screen, we want to boot it in Recovery or DFU mode by adhering to the on-screen directions. Therefore, the Recovery mode is suggested for the iOS lock screen. Yet, if you can't actuate the Recovery mode, you can also use the DFU mode.
...
After putting the Apple iPhone 6s device in DFU mode, Dr.Fone will show the Apple iPhone 6s device information, for example, the Apple iPhone 6s device Model and OS Variant. You can choose the correct data from the dropdown menu if the information is incorrect. Then, at that point, click Download to download the firmware for your device.

![select phone model](https://images.wondershare.com/drfone/guide/unlock-ios-screen-4.png)

**Step 4. Unlock the Apple iPhone 6s screen lock**

After the firmware is downloaded effectively, click Unlock Now to begin unlocking your Apple iPhone 6s/iPad.

![unlock now](https://images.wondershare.com/drfone/guide/unlock-ios-screen-6.png)

Simply shortly, your Apple iPhone 6s will be unlocked effectively. Note that this unlocking process will wipe the user data on your Apple iPhone 6s. However, it is practical to erase this issue from your device.
...
<li><a href="https://smart-video-editing.techidaily.com/2024-approved-recording-voice-overs-in-fcp-like-a-pro-top-tips-and-tricks/"><u>2024 Approved Recording Voice Overs in FCP Like a Pro Top Tips & Tricks</u></a></li>
</ul></div>

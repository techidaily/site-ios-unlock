...
date: 2024-04-30T17:13:20.809Z
updated: 2024-05-01T17:13:20.809Z
tags: 
  - unlock
  - remove screen lock
categories:
...
keywords: unlock iphone 5 passcode without itunes,unlock disabled iphone 13,get out of security lockout,change country on iphone app store,disable parental control,how to unlock iphone with broken screen,change apple id password,iphone passcode changed itself,fix iphone unavailability,ios 17 lock screen,iphone asking for outlook password
...
**Step 1. Connect the locked Apple iPhone 11 to the PC**

Connect your locked Apple iPhone 11 to your PC through a lightning or USB connector. Open iTunes on Windows PC.

**Step 2. Put your Apple iPhone 11 in recovery mode**

To enter a Recovery Mode, press a combination of buttons on your Apple iPhone 11. Doing such, you will see a recovery mode screen on your Apple iPhone 11. To place the Apple iPhone 11 in Recovery mode, follow these:
...
**Note:** If you see the passcode screen, switch off your Apple iPhone 11 and do the process again until you see the Recovery mode screen.

**Step 3. Restore your Apple iPhone 11**

As the recovery Mode screen shows up on the iPhone, you will find your Apple iPhone 11 on **iTunes unlock phone** screen. Then, a box shows up with a message saying there is an iPhone issue. It will expect you to update or restore your phone. So, click on Restore.

![click restore](https://images.wondershare.com/drfone/article/2022/11/how-to-unlock-iphone-with-itunes-1.jpg)

**Step 4.** It then asks you to confirm whether you are sure you need to restore the Apple iPhone 11 to its default factory state. It does so because your media and data will be all erased. Then, click on Restore and Update.

**Step 5.** Then, "iPhone Software Update" may spring up. Click Next, and afterwards, click Agree. iTunes will begin downloading the software and restore your Apple iPhone 11 when the download is finished.

When the "iPhone software update" is downloaded, iTunes will show that it will erase your Apple iPhone 11 and restore it to iOS 15.4.1. Then click on Restore.
...
**Step 6.** Your Apple iPhone 11 will show the restore progress bar with the white apple logo. The length of the process relies upon how much data is on your cell phone. Generally, it takes 20 to 120 minutes. When done, your Apple iPhone 11 will restart naturally. Furthermore, after your Apple iPhone 11 restarts, you can reset your Apple iPhone 11. For example, you can make a new passcode.

## Part 3: Unlocking iPhone without iTunes

### 1\. Unlock it with Find My in iCloud

Find My is a famous element in Apple devices that allows you to find your lost phone through Maps. The component has been updated from that point forward, and presently it can be utilized to erase your Apple iPhone 11. Additionally, you can use it to erase your information without a passcode.
...
**Step 8.** The iCloud will effectively begin the erase, and you can see the Apple sign with a white advancement bar noticeable on your locked iPhone. After an effective erase process, your Apple iPhone 11 will restart.

**Step 9.** Swipe up on the Apple iPhone 11 screen to begin once more.
...
Before deleting the Apple iPhone 11 screen, it is necessary to boot it in Recovery/DFU. You can follow the steps on your screen to do so. Moreover, the Recovery mode is the suggested way for your situation. However, you can use the DFU mode if this doesn't work.
...
Dr.Fone is a set of modules that make life easy for you. Any kind of problem you can think of, it is likely that Dr.Fone has a remedy for it ready in its arsenal. A locked Apple iPhone 11 is no different. Here is how to use Dr.Fone - Screen Unlock (iOS) to unlock Apple iPhone 11 passcode:

Step 1: Install Dr.Fone - Screen Unlock (iOS) on your computer.

Step 2: Connect your locked Apple iPhone 11 to the computer.
...
Step 5: Follow the on-screen instructions to boot the Apple iPhone 11 in Recovery Mode. If for some reason you are unable to boot into Recovery Mode, there are instructions at the bottom to enter DFU mode.
...
Find My allows you to unlock your Apple iPhone 11 remotely if you want to. So, if you have forgotten the passcode and are unable to unlock your Apple iPhone 11, there is a way you can unlock it using Find My. Doing this will wipe your data from the Apple iPhone 11 device and set it up as new, though. Here is how to do that:

Step 1: If you have any other Apple device that is logged in with the same Apple ID as the Apple iPhone 11, you can launch Find My on that device. Else, you can visit [https://icloud.com](https://icloud.com/) and log into the same iCloud account/ Apple ID as the locked Apple iPhone 11.

Step 2: Under Find My (or Find My iPhone if you are using the iCloud website), select your Apple iPhone 11 and click Erase iPhone and confirm.
...
You can unlock your Apple iPhone 11 using Recovery Mode, yourself.

Step 1: Connect your Apple iPhone 11 to the computer and open iTunes. If you are on a Mac that runs macOS Catalina or higher, open Finder.
...
You're done. Now go ahead and forget the passcode forever. You will not need it again. Do note, however, that not using a passcode on your Apple iPhone 11 leaves not only your data but your Apple iPhone 11 itself in a highly vulnerable state. Anyone with access to your device can do anything on the Apple iPhone 11 device that you could, including setting up a passcode that you will then have to use this guide to unlock.

## Part IV: More information about Apple iPhone 11/Apple iPhone 11 mini/Apple iPhone 11 Pro

The ways mentioned before should help you get out of the locked Apple iPhone 11 now. Here is a shortlist of the features of the Apple iPhone 11 range. You may learn more information about Apple iPhone 11 range that you may never know before.

**5G Capability and Dual eSIM Support**

The Apple iPhone 11 range builds on the Apple iPhone 11 12 range for 5G capability by supporting more bands than the Apple iPhone 11 12 lineup. 5G modems are the same across the Apple iPhone 11 lineup. the Apple iPhone 11 lineup supports dual eSIM for the first time ever in iPhones. You do get a physical SIM tray for one nano-SIM though, so don't sit up.

**Cinematic Mode**

You might be wondering if you will get the highlight Cinematic Mode if you were to pick the cheapest of the Apple iPhone 11 lineup, that is, the Apple iPhone 11 mini. The answer is yes, you will. All Apple iPhone 11 models support Cinematic Mode.

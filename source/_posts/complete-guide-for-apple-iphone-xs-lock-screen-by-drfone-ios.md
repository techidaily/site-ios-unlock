---
title: Complete Guide For Apple iPhone XS Lock Screen
date: 2024-07-15T03:03:09.662Z
updated: 2024-07-16T03:03:09.662Z
tags: 
  - unlock
  - remove screen lock
categories:
...
keywords: unlock iphone with apple watch,iphone lock screen with notifications,bypass iphone passcode,unlock iphone face id wearing mask,unlock iphone xs without passcode,erase iphone when locked
...
**Note:** You can only use Live Photos for your lock screen if your Apple iPhone XS is unlocked.
...
If you want to set the Auto-Lock time, go to Settings > Display & Brightness > Auto-Lock. Here, you can choose how long it should take for your Apple iPhone XS to lock automatically.
...
If your Apple iPhone XS needs to be backed up with iTunes sync feature, you can use this method to bypass the passcode.

To do this, connect your Apple iPhone XS to a computer and open iTunes. Then, click the Restore button and follow the on-screen instructions to restore your Apple iPhone XS.

It will take some time, but you can use your Apple iPhone XS without a passcode once it's done.
...
If you have synced your Apple iPhone XS with iCloud, you can try the Find My feature to bypass the lock screen.
...
All the data will disappear on your Apple iPhone XS, and you'll be able to access it without a passcode.

This process can also take some time, so be patient.

![find My Apple iPhone XS feature](https://images.wondershare.com/drfone/article/2022/11/ios-15-lock-screen-8.jpg)
...
**Step #3: Connect your Apple iPhone XS and Activate DFU Mode**

Now, you need to connect your Apple iPhone XS to the computer using an Apple original cable. Once done, you need to put your Apple iPhone XS into DFU mode.
...
Once Dr.Fone detects your Apple iPhone XS, it will ask you to continue. So, proceed to the next, and here you will be asked to download the correct firmware package for your device.
...
After the firmware is downloaded, you need to press the Unlock Now button, and Dr.Fone will start to unlock your Apple iPhone XS without a passcode. Once it is done, you can get into your device without any restriction.

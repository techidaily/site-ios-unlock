...
date: 2024-07-14T23:59:47.139Z
updated: 2024-07-15T23:59:47.139Z
tags: 
  - unlock
  - remove screen lock
categories:
  - ios
  - iphone
description: This article describes How To Change Country on App Store for Apple iPhone 6s With 7 Methods
excerpt: This article describes How To Change Country on App Store for Apple iPhone 6s With 7 Methods
keywords: unlock disabled iphone 13,unlock iphone without passcode,how to unlock iphone without passcode,unlock iphone xs without passcode,how to turn off find my iphone when phone is broken,forgot locked note password,iphone passcode not working after update ios 13,how to unlock iphone with itunes,ios 17 lock screen,change country on iphone app store
...
**Step 1. Connect the locked Apple iPhone 6s to the PC**

Connect your locked Apple iPhone 6s to your PC through a lightning or USB connector. Open iTunes on Windows PC.

**Step 2. Put your Apple iPhone 6s in recovery mode**

To enter a Recovery Mode, press a combination of buttons on your Apple iPhone 6s. Doing such, you will see a recovery mode screen on your Apple iPhone 6s. To place the Apple iPhone 6s in Recovery mode, follow these:
...
**Note:** If you see the passcode screen, switch off your Apple iPhone 6s and do the process again until you see the Recovery mode screen.

**Step 3. Restore your Apple iPhone 6s**

As the recovery Mode screen shows up on the iPhone, you will find your Apple iPhone 6s on **iTunes unlock phone** screen. Then, a box shows up with a message saying there is an iPhone issue. It will expect you to update or restore your phone. So, click on Restore.
...
**Step 4.** It then asks you to confirm whether you are sure you need to restore the Apple iPhone 6s to its default factory state. It does so because your media and data will be all erased. Then, click on Restore and Update.

**Step 5.** Then, "iPhone Software Update" may spring up. Click Next, and afterwards, click Agree. iTunes will begin downloading the software and restore your Apple iPhone 6s when the download is finished.

When the "iPhone software update" is downloaded, iTunes will show that it will erase your Apple iPhone 6s and restore it to iOS 15.4.1. Then click on Restore.
...
**Step 6.** Your Apple iPhone 6s will show the restore progress bar with the white apple logo. The length of the process relies upon how much data is on your cell phone. Generally, it takes 20 to 120 minutes. When done, your Apple iPhone 6s will restart naturally. Furthermore, after your Apple iPhone 6s restarts, you can reset your Apple iPhone 6s. For example, you can make a new passcode.

## Part 3: Unlocking iPhone without iTunes

### 1\. Unlock it with Find My in iCloud

Find My is a famous element in Apple devices that allows you to find your lost phone through Maps. The component has been updated from that point forward, and presently it can be utilized to erase your Apple iPhone 6s. Additionally, you can use it to erase your information without a passcode.
...
**Step 8.** The iCloud will effectively begin the erase, and you can see the Apple sign with a white advancement bar noticeable on your locked iPhone. After an effective erase process, your Apple iPhone 6s will restart.

**Step 9.** Swipe up on the Apple iPhone 6s screen to begin once more.
...
If you are searching for an elective way to unlock your Apple iPhone 6s with iTunes, you can pick Wondershare Dr.Fone-Screen Unlock.
...
Before deleting the Apple iPhone 6s screen, it is necessary to boot it in Recovery/DFU. You can follow the steps on your screen to do so. Moreover, the Recovery mode is the suggested way for your situation. However, you can use the DFU mode if this doesn't work.
...
Doing so will unlock your Apple iPhone 6s within no time. However, kindly note this unlocking process will likewise wipe your Apple iPhone 6s's user data. Indeed, each solution removes your data. Therefore, you must be careful enough to back up your files before doing this process.
